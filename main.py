...
from travel_tool import get_flights, suggest_hotels
...
explorer_agent = Agent(
    name="ExplorerAgent",
    instructions="You suggesst food places to explore in the destination.",
    model=model,
)
...
def main():
    ...
    result3 = Runner.run_sync(explorer_agent, dest, run_config=config)
